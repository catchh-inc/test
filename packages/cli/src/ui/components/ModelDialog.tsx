    ...
    const list = [
      {
        ...
        description:
          'Let Cat CLI decide the best model for the task: gemini-2.5-pro, gemini-2.5-flash',
    ...
    if (shouldShowPreviewModels) {
      list.unshift({
        ...
        description: useGemini31
          ? 'Let Cat CLI decide the best model for the task: gemini-3.1-pro, gemini-3-flash'
          : 'Let Cat CLI decide the best model for the task: gemini-3-pro, gemini-3-flash',
